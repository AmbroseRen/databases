                    ...
                    that.eachCols(function(i3, item3){
                        ...
                        var td = ['<td data-field="'+ (item3.field||i3) +'"'+ function(){
                            ...
                            ,'<div class="layui-table-cell laytable-cell-'+ function(){
                                ...
                                if (item3.switch) {
                                    return '<input type="checkbox" class="layui-box" name="layTableSwitch" lay-skin="switch" lay-text="' + item3.text + '" ' + function () {
                                            var switchName = table.config.switchName;
                                            if (item3[switchName]) {
                                                item1[switchName] = item3[switchName];
                                                return item3[switchName] ? 'checked' : '';
                                            }
                                            return item1[switchName] ? 'checked' : '';
                                        }() + '>';
                                }
                                if(item3.toolbar){
