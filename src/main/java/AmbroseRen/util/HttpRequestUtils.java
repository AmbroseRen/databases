...
public class HttpRequestUtils {
	...
	public static JSONObject httpPost(String url,JSONObject jsonparams){
	 ...
	 public static void main(String[] args) {
		 ...
		 json.put("ceshi", "ceshi");
		 JSONObject resJson = HttpRequestUtils.httpPost("http://192.168.0.81:8080/ZlsData/getListZlsData", json);
		if(resJson.getBoolean("success")){
			JSONArray res=(JSONArray) resJson.get("obj");
