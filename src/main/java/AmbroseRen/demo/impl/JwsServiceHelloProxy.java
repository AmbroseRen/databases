...
public class JwsServiceHelloProxy implements AmbroseRen.demo.impl.JwsServiceHello {
  private String _endpoint = null;
  private AmbroseRen.demo.impl.JwsServiceHello jwsServiceHello = null;
  ...
  private void _initJwsServiceHelloProxy() {
    try {
      jwsServiceHello = (new AmbroseRen.demo.impl.JwsServiceHelloServiceLocator()).getJwsServiceHelloPort();
  ...
  public AmbroseRen.demo.impl.JwsServiceHello getJwsServiceHello() {
    if (jwsServiceHello == null)
      _initJwsServiceHelloProxy();
